...
start() ->
     Wx=wx:new(),
     F=wxFrame:new(Wx, ?wxID_ANY, "Regerlang, parsing files with ease", [{size, {800,500}}]),
     wxFrame:show(F),
     ...
     Button_regex = wxButton:new(F, ?wxID_ANY, [{label, "Do the regex scan"}, {pos,{0, 214}}, {size, {150, 50}}]),
